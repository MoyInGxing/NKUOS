...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800034:	54850513          	addi	a0,a0,1352 # 800578 <main+0x44>
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80005c:	54050513          	addi	a0,a0,1344 # 800598 <main+0x64>
...
exit(int error_code) {
  ...
  80012c:	47850513          	addi	a0,a0,1144 # 8005a0 <main+0x6c>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800188:	43478793          	addi	a5,a5,1076 # 8005b8 <main+0x84>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8001e0:	504a8a93          	addi	s5,s5,1284 # 8006e0 <main+0x1ac>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  8003e8:	45478793          	addi	a5,a5,1108 # 800838 <error_string>
  ...
  8003fc:	1f060613          	addi	a2,a2,496 # 8005e8 <main+0xb4>
  ...
  800410:	1cc60613          	addi	a2,a2,460 # 8005d8 <main+0xa4>
  ...
  8004aa:	12b40413          	addi	s0,s0,299 # 8005d1 <main+0x9d>
  8004ae:	5dfd                	li	s11,-1
  8004b0:	b5f9                	j	80037e <vprintfmt+0x1ce>
  8004b2:	00000417          	auipc	s0,0x0
  8004b6:	11f40413          	addi	s0,s0,287 # 8005d1 <main+0x9d>
                p = "(null)";
  8004ba:	00000717          	auipc	a4,0x0
  8004be:	11670713          	addi	a4,a4,278 # 8005d0 <main+0x9c>
...
main(void) {
  ...
  800538:	acc72703          	lw	a4,-1332(a4) # 801000 <zero>
main(void) {
  80053c:	1141                	addi	sp,sp,-16
  80053e:	e406                	sd	ra,8(sp)
    cprintf("value is %d.\n", 1 / zero);
  800540:	0017079b          	addiw	a5,a4,1
  800544:	0037b793          	sltiu	a5,a5,3
  800548:	0007059b          	sext.w	a1,a4
  80054c:	e391                	bnez	a5,800550 <main+0x1c>
  80054e:	4581                	li	a1,0
  800550:	00000517          	auipc	a0,0x0
  800554:	16050513          	addi	a0,a0,352 # 8006b0 <main+0x17c>
  800558:	b4dff0ef          	jal	8000a4 <cprintf>
    panic("FAIL: T.T\n");
  80055c:	00000617          	auipc	a2,0x0
  800560:	16460613          	addi	a2,a2,356 # 8006c0 <main+0x18c>
  800564:	45a5                	li	a1,9
  800566:	00000517          	auipc	a0,0x0
  80056a:	16a50513          	addi	a0,a0,362 # 8006d0 <main+0x19c>
  80056e:	ab9ff0ef          	jal	800026 <__panic>
