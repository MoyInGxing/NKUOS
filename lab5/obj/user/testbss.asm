...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800034:	5b850513          	addi	a0,a0,1464 # 8005e8 <main+0xb4>
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80005c:	5b050513          	addi	a0,a0,1456 # 800608 <main+0xd4>
...
exit(int error_code) {
  ...
  80012c:	4e850513          	addi	a0,a0,1256 # 800610 <main+0xdc>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800188:	4a478793          	addi	a5,a5,1188 # 800628 <main+0xf4>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8001e0:	608a8a93          	addi	s5,s5,1544 # 8007e4 <main+0x2b0>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  8003e8:	55c78793          	addi	a5,a5,1372 # 800940 <error_string>
  ...
  8003fc:	26060613          	addi	a2,a2,608 # 800658 <main+0x124>
  ...
  800410:	23c60613          	addi	a2,a2,572 # 800648 <main+0x114>
  ...
  8004aa:	19b40413          	addi	s0,s0,411 # 800641 <main+0x10d>
  8004ae:	5dfd                	li	s11,-1
  8004b0:	b5f9                	j	80037e <vprintfmt+0x1ce>
  8004b2:	00000417          	auipc	s0,0x0
  8004b6:	18f40413          	addi	s0,s0,399 # 800641 <main+0x10d>
                p = "(null)";
  8004ba:	00000717          	auipc	a4,0x0
  8004be:	18670713          	addi	a4,a4,390 # 800640 <main+0x10c>
...
main(void) {
  ...
  80053a:	1ea50513          	addi	a0,a0,490 # 800720 <main+0x1ec>
main(void) {
  80053e:	e406                	sd	ra,8(sp)
    cprintf("Making sure bss works right...\n");
  800540:	b65ff0ef          	jal	8000a4 <cprintf>
    int i;
    for (i = 0; i < ARRAYSIZE; i ++) {
  800544:	00001597          	auipc	a1,0x1
  800548:	abc58593          	addi	a1,a1,-1348 # 801000 <bigarray>
    cprintf("Making sure bss works right...\n");
  80054c:	87ae                	mv	a5,a1
    for (i = 0; i < ARRAYSIZE; i ++) {
  80054e:	4681                	li	a3,0
  800550:	00100637          	lui	a2,0x100
  800554:	a029                	j	80055e <main+0x2a>
  800556:	2685                	addiw	a3,a3,1
  800558:	0791                	addi	a5,a5,4
  80055a:	00c68f63          	beq	a3,a2,800578 <main+0x44>
        if (bigarray[i] != 0) {
  80055e:	4398                	lw	a4,0(a5)
  800560:	db7d                	beqz	a4,800556 <main+0x22>
            panic("bigarray[%d] isn't cleared!\n", i);
  800562:	00000617          	auipc	a2,0x0
  800566:	1de60613          	addi	a2,a2,478 # 800740 <main+0x20c>
  80056a:	45b9                	li	a1,14
  80056c:	00000517          	auipc	a0,0x0
  800570:	1f450513          	addi	a0,a0,500 # 800760 <main+0x22c>
  800574:	ab3ff0ef          	jal	800026 <__panic>
  800578:	00001717          	auipc	a4,0x1
  80057c:	a8870713          	addi	a4,a4,-1400 # 801000 <bigarray>
        }
    }
    for (i = 0; i < ARRAYSIZE; i ++) {
  800580:	4781                	li	a5,0
  800582:	001006b7          	lui	a3,0x100
        bigarray[i] = i;
  800586:	c31c                	sw	a5,0(a4)
    for (i = 0; i < ARRAYSIZE; i ++) {
  800588:	2785                	addiw	a5,a5,1
  80058a:	0711                	addi	a4,a4,4
  80058c:	fed79de3          	bne	a5,a3,800586 <main+0x52>
    }
    for (i = 0; i < ARRAYSIZE; i ++) {
  800590:	4681                	li	a3,0
  800592:	00100737          	lui	a4,0x100
  800596:	a029                	j	8005a0 <main+0x6c>
  800598:	2685                	addiw	a3,a3,1 # 100001 <_start-0x70001f>
  80059a:	0591                	addi	a1,a1,4
  80059c:	02e68063          	beq	a3,a4,8005bc <main+0x88>
        if (bigarray[i] != i) {
  8005a0:	419c                	lw	a5,0(a1)
  8005a2:	fed78be3          	beq	a5,a3,800598 <main+0x64>
            panic("bigarray[%d] didn't hold its value!\n", i);
  8005a6:	00000617          	auipc	a2,0x0
  8005aa:	1ca60613          	addi	a2,a2,458 # 800770 <main+0x23c>
  8005ae:	45d9                	li	a1,22
  8005b0:	00000517          	auipc	a0,0x0
  8005b4:	1b050513          	addi	a0,a0,432 # 800760 <main+0x22c>
  ...
  8005c0:	1dc50513          	addi	a0,a0,476 # 800798 <main+0x264>
  8005c4:	ae1ff0ef          	jal	8000a4 <cprintf>
    cprintf("testbss may pass.\n");
  8005c8:	00000517          	auipc	a0,0x0
  8005cc:	20850513          	addi	a0,a0,520 # 8007d0 <main+0x29c>
  8005d0:	ad5ff0ef          	jal	8000a4 <cprintf>
  ...
  8005d4:	4501                	li	a0,0
    bigarray[ARRAYSIZE + 1024] = 0;
  8005d6:	00402797          	auipc	a5,0x402
  8005da:	a207a523          	sw	zero,-1494(a5) # c02000 <bigarray+0x401000>
    exit(0);
  8005de:	b43ff0ef          	jal	800120 <exit>
