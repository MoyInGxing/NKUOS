...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800034:	53850513          	addi	a0,a0,1336 # 800568 <main+0x34>
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80005c:	53050513          	addi	a0,a0,1328 # 800588 <main+0x54>
...
exit(int error_code) {
  ...
  80012c:	46850513          	addi	a0,a0,1128 # 800590 <main+0x5c>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800188:	42478793          	addi	a5,a5,1060 # 8005a8 <main+0x74>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8001e0:	50ca8a93          	addi	s5,s5,1292 # 8006e8 <main+0x1b4>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  8003e8:	45c78793          	addi	a5,a5,1116 # 800840 <error_string>
  ...
  8003fc:	1e060613          	addi	a2,a2,480 # 8005d8 <main+0xa4>
  ...
  800410:	1bc60613          	addi	a2,a2,444 # 8005c8 <main+0x94>
  ...
  8004aa:	11b40413          	addi	s0,s0,283 # 8005c1 <main+0x8d>
  8004ae:	5dfd                	li	s11,-1
  8004b0:	b5f9                	j	80037e <vprintfmt+0x1ce>
  8004b2:	00000417          	auipc	s0,0x0
  8004b6:	10f40413          	addi	s0,s0,271 # 8005c1 <main+0x8d>
                p = "(null)";
  8004ba:	00000717          	auipc	a4,0x0
  8004be:	10670713          	addi	a4,a4,262 # 8005c0 <main+0x8c>
...
main(void) {
  ...
  800534:	3eb00793          	li	a5,1003
  800538:	07da                	slli	a5,a5,0x16
  80053a:	438c                	lw	a1,0(a5)
main(void) {
  80053c:	1141                	addi	sp,sp,-16
    cprintf("I read %08x from 0xfac00000!\n", *(unsigned *)0xfac00000);
  80053e:	00000517          	auipc	a0,0x0
  800542:	16250513          	addi	a0,a0,354 # 8006a0 <main+0x16c>
main(void) {
  800546:	e406                	sd	ra,8(sp)
    cprintf("I read %08x from 0xfac00000!\n", *(unsigned *)0xfac00000);
  800548:	b5dff0ef          	jal	8000a4 <cprintf>
    panic("FAIL: T.T\n");
  80054c:	00000617          	auipc	a2,0x0
  800550:	17460613          	addi	a2,a2,372 # 8006c0 <main+0x18c>
  800554:	459d                	li	a1,7
  800556:	00000517          	auipc	a0,0x0
  80055a:	17a50513          	addi	a0,a0,378 # 8006d0 <main+0x19c>
  80055e:	ac9ff0ef          	jal	800026 <__panic>
