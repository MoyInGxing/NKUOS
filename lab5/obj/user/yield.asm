...
exit(int error_code) {
  ...
  8000d0:	47c50513          	addi	a0,a0,1148 # 800548 <main+0x6c>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800130:	43478793          	addi	a5,a5,1076 # 800560 <main+0x84>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800188:	554a8a93          	addi	s5,s5,1364 # 8006d8 <main+0x1fc>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  800390:	4a478793          	addi	a5,a5,1188 # 800830 <error_string>
  ...
  8003a4:	1f860613          	addi	a2,a2,504 # 800598 <main+0xbc>
  ...
  8003b8:	1d460613          	addi	a2,a2,468 # 800588 <main+0xac>
  ...
  800452:	12b40413          	addi	s0,s0,299 # 800579 <main+0x9d>
  800456:	5dfd                	li	s11,-1
  800458:	b5f9                	j	800326 <vprintfmt+0x1ce>
  80045a:	00000417          	auipc	s0,0x0
  80045e:	11f40413          	addi	s0,s0,287 # 800579 <main+0x9d>
                p = "(null)";
  800462:	00000717          	auipc	a4,0x0
  800466:	11670713          	addi	a4,a4,278 # 800578 <main+0x9c>
...
int
main(void) {
  8004dc:	1101                	addi	sp,sp,-32
  8004de:	ec06                	sd	ra,24(sp)
  8004e0:	e822                	sd	s0,16(sp)
  8004e2:	e426                	sd	s1,8(sp)
    int i;
    cprintf("Hello, I am process %d.\n", getpid());
  8004e4:	bf9ff0ef          	jal	8000dc <getpid>
  8004e8:	85aa                	mv	a1,a0
  8004ea:	00000517          	auipc	a0,0x0
  8004ee:	17650513          	addi	a0,a0,374 # 800660 <main+0x184>
  8004f2:	b4fff0ef          	jal	800040 <cprintf>
    for (i = 0; i < 5; i ++) {
  8004f6:	4401                	li	s0,0
  8004f8:	4495                	li	s1,5
        yield();
  8004fa:	be1ff0ef          	jal	8000da <yield>
        cprintf("Back in process %d, iteration %d.\n", getpid(), i);
  8004fe:	bdfff0ef          	jal	8000dc <getpid>
  800502:	85aa                	mv	a1,a0
  800504:	8622                	mv	a2,s0
  800506:	00000517          	auipc	a0,0x0
  80050a:	17a50513          	addi	a0,a0,378 # 800680 <main+0x1a4>
    for (i = 0; i < 5; i ++) {
  80050e:	2405                	addiw	s0,s0,1
        cprintf("Back in process %d, iteration %d.\n", getpid(), i);
  800510:	b31ff0ef          	jal	800040 <cprintf>
    for (i = 0; i < 5; i ++) {
  800514:	fe9413e3          	bne	s0,s1,8004fa <main+0x1e>
    }
    cprintf("All done in process %d.\n", getpid());
  800518:	bc5ff0ef          	jal	8000dc <getpid>
  80051c:	85aa                	mv	a1,a0
  80051e:	00000517          	auipc	a0,0x0
  800522:	18a50513          	addi	a0,a0,394 # 8006a8 <main+0x1cc>
  800526:	b1bff0ef          	jal	800040 <cprintf>
    cprintf("yield pass.\n");
  80052a:	00000517          	auipc	a0,0x0
  80052e:	19e50513          	addi	a0,a0,414 # 8006c8 <main+0x1ec>
  800532:	b0fff0ef          	jal	800040 <cprintf>
    return 0;
}
  800536:	60e2                	ld	ra,24(sp)
  800538:	6442                	ld	s0,16(sp)
  80053a:	64a2                	ld	s1,8(sp)
  80053c:	4501                	li	a0,0
  80053e:	6105                	addi	sp,sp,32
  800540:	8082                	ret
