...
exit(int error_code) {
  ...
  8000c8:	41c50513          	addi	a0,a0,1052 # 8004e0 <main+0x10>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800124:	3d878793          	addi	a5,a5,984 # 8004f8 <main+0x28>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  80017c:	480a8a93          	addi	s5,s5,1152 # 8005f8 <main+0x128>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  800384:	3d078793          	addi	a5,a5,976 # 800750 <error_string>
  ...
  800398:	19c60613          	addi	a2,a2,412 # 800530 <main+0x60>
  ...
  8003ac:	17860613          	addi	a2,a2,376 # 800520 <main+0x50>
  ...
  800446:	0cf40413          	addi	s0,s0,207 # 800511 <main+0x41>
  80044a:	5dfd                	li	s11,-1
  80044c:	b5f9                	j	80031a <vprintfmt+0x1ce>
  80044e:	00000417          	auipc	s0,0x0
  800452:	0c340413          	addi	s0,s0,195 # 800511 <main+0x41>
                p = "(null)";
  800456:	00000717          	auipc	a4,0x0
  80045a:	0ba70713          	addi	a4,a4,186 # 800510 <main+0x40>
...
main(void) {
  8004d4:	e406                	sd	ra,8(sp)
    exit(0);
  8004d6:	be7ff0ef          	jal	8000bc <exit>
